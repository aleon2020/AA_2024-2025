...
# 
# Los ejes ortogonales (componentes principales) del nuevo subespacio pueden interpretarse como las direcciones de máxima varianza dada la restricción de que los nuevos ejes de características son ortogonales entre sí, donde x1 y x2 son los ejes característicos originales, y PC 1 y PC 2 son los componentes principales:
